...
export default class Edit extends Component {
    ...
    componentDidMount() {
        axios.get('http://localhost:3002/disciplina/' + this.props.match.params.id)
            .then(
                (res) => {
                    this.setState(
                        {
    ...
    onSubmit(e) {
        ...
        axios.put('http://localhost:3002/disciplina/' + this.props.match.params.id, disciplinaEditada)
            .then(
                res => {
